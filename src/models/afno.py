...
class MixerBlock(nn.Module):
    def __init__(self, dim, h, w, fno_blocks, fno_softshrink, channels_mlp_dim, drop=0.):
        super().__init__()
...
class Network(nn.Module):
    def __init__(
                self, img_size_in, img_size_out, patch_size, in_chans, out_chans, embed_dim, 
                fno_blocks, fno_softshrink, channels_mlp_dim, num_blocks, drop_rate=0., **kwargs):
        super().__init__()
        ...
        layers = [ 
            MixerBlock(embed_dim, h, w, fno_blocks, fno_softshrink, channels_mlp_dim, drop=drop_rate)
